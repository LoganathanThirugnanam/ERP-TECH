...
Create   or alter procedure grtgrrinhcmbstalod                                          
 @ctxt_user                     Ctxt_User,  
...
Begin  
 ...
 --select null    'HDNSTATUS',  
 --  null    '_gr_rev_status'   
 --union   
 select rtrim(paramcode) 'HDNSTATUS',  
   rtrim(paramdesc) '_gr_rev_status'   
 from component_metadata_table(NOLOCK)  
 where componentname = 'GR'  
 and  paramcategory = 'META'  
 and  paramtype  = 'DOC_STATUS'  
 and  paramcode       in ('FM')  
 --and  paramcode       in ('FA','PA','FM','PM','FZ','RE')  
