...
Create   or alter procedure grtgrrinhcmbrftlod                                          
 @ctxt_user                     Ctxt_User,  
...
Begin  
 ...
 select   
   rtrim(paramcode)  'HDN_REFDOCTYPE',  
   --1 '_gr_rev_type'     
  rtrim(paramdesc)  '_gr_rev_type'  
 from component_metadata_table(NOLOCK)  
 where componentname   = 'GR'  
 and  paramcategory   = 'COMBO'  
 and  paramtype    = 'REFTYPE_REV'  
