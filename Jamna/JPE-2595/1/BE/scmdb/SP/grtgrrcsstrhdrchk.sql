...
Create   or alter procedure grtgrrcsstrhdrchk                                          
 @ctxt_user                     Ctxt_User,  
...
--if @modeflag in ('S')  
--Select 173,@grrevm_fprowno  
  
If @grrevm_fprowno <=0  
begin  
 RAISERROR('Please select at least one row in the multiline.', 16, 1);  
    RETURN;   
end  
