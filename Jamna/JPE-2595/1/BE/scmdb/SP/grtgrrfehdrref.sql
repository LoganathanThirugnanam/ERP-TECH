...
Create   OR ALTER procedure grtgrrfehdrref                                          
 @ctxt_user                     Ctxt_User,  
...
Begin  
 ...
 select  @_gr_adhoc_ite = rtrim(paramdesc)  
 from component_metadata_table(NOLOCK)  
 where componentname = 'GR'  
 and  paramcategory = 'META'  
 and  paramtype  = 'ADHOCITCLS'  
 and  paramcode  = 'AL'  
 and  langid   = @ctxt_language  
  
 Select    
  @_desc                         '_desc',  
  @_gr_adhoc_ite                 '_gr_adhoc_ite',  
  @_gr_folder                    '_gr_folder',  
  @_gr_name                      '_gr_name',  
  @_gr_rev_date_fr               '_gr_rev_date_fr',  
  @_gr_rev_date_to               '_gr_rev_date_to',  
  @_gr_rev_datefr                '_gr_rev_datefr',  
  @_gr_rev_dateto                '_gr_rev_dateto',  
  @_gr_rev_fold                  '_gr_rev_fold',  
  @_gr_rev_itmcode               '_gr_rev_itmcode',  
  @_gr_rev_receiptfrom           '_gr_rev_receiptfrom',  
  @_gr_rev_receiptto             '_gr_rev_receiptto',  
  @_gr_rev_reffr                 '_gr_rev_reffr',  
  @_gr_rev_refto                 '_gr_rev_refto',  
  @_gr_rev_status                '_gr_rev_status',  
  @_gr_rev_type                  '_gr_rev_type',  
  @_gr_rev_variant               '_gr_rev_variant',  
  @_gr_supplier_code             '_gr_supplier_code',  
  @_guid                         '_guid',  
  @_hidden1                      '_hidden1',  
  @_hiddenou                     '_hiddenou',  
